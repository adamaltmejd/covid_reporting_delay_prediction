...
#'
#'@param model_death_dt   - data for deaths so far
#'@param death_prediction - data.frame with predicitions
...
coverage.plot <- function(coverage, days.ago, type, theme=NULL){
...
#' @param lag      - only report for result lag days ago
probability_analysis <- function(model_death_dt ,theme,days.reported=10, lag = 20, N_min=5){
